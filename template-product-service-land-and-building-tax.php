...
<?php
/**
 * Template Name: Land and Building Tax
                ...
                <div class="product-sidebar">
                  <div class="card product-sidebar-content">
                    ...
                    <div class="card-content">
                      <div class="content">
                        <h3 class="has-text-primary"><?php pll_e('Contact to use our services'); ?></h3>
                        <div class="land-and-building-tax-form"><land-and-building-tax-form></land-and-building-tax-form></div>
                      </div>
                    </div>
                  </div>
                </div>
